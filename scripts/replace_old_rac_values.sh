...
| while read f; do
    ...
    sed -i \
      -e 's/mzr1\.lab\.mzr/mzr1.lab.maz/g' \
      -e 's/mzr2\.lab\.mzr/mzr2.lab.maz/g' \
      -e 's/mzr1-priv\.lab\.mzr/mzr1-priv.lab.maz/g' \
      -e 's/mzr2-priv\.lab\.mzr/mzr2-priv.lab.maz/g' \
      -e 's/mzr1-vip\.lab\.mzr/mzr1-vip.lab.maz/g' \
      -e 's/mzr2-vip\.lab\.mzr/mzr2-vip.lab.maz/g' \
      -e 's/mzr-scan\.lab\.mzr/mzr-scan.lab.maz/g' \
